...
date: 2014-09-03 11:53
comments: false
summary: The problem - Old corporations use shitty old software to do things that modern Linux is really good at doing itself.  Using pmksh instead of a well laid out sudoers setup is what the problem is.
categories: ansible
---
